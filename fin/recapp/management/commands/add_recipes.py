...
class Command(BaseCommand):
    def handle(self, *args, **kwargs):
        names = ['Завтрак караванщика', 'Жаркое из кротокрыса', 'Пустынный салат', 'Шашлык из игуаны', 'Трэйс-микс', 'Чёртово жаркое Шеф-Шефа', 'Чудо-мясо', 'Фрикасе из огненного муравья', 'Омлет', 'Стейк из брамина', 'Хрустящий мутафрукт', 'Чипсы']
        descs = ['Эти консервы содержат от 91 до 93% жареных мозгов и от 7 до 9% костного топленого жира; они очень вкусны', 'Если сырое мясо посолить, то через некоторое время оно начнет выделять сок', 'Вкусное, легкое, питательное блюдо, в состав которого входят овощи', 'Одно из самых деликатесных блюд мясной кулинарии', 'Пища лучше усваивается, если ее едят с аппетитом', 'Вкусное и весьма питательное блюдо – печень в конверте', 'Эти консервы содержат от 91 до 93% жареных мозгов и от 7 до 9% костного топленого жира; они очень вкусны', 'Если сырое мясо посолить, то через некоторое время оно начнет выделять сок', 'Вкусное, легкое, питательное блюдо, в состав которого входят овощи', 'Одно из самых деликатесных блюд мясной кулинарии', 'Пища лучше усваивается, если ее едят с аппетитом', 'Вкусное и весьма питательное блюдо – печень в конверте']
        times = [15, 8, 4, 42, 23, 16, 1, 2, 3, 100, 5, 6]
